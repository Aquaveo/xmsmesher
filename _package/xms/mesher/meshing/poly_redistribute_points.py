...
class PolyRedistributePoints(object):
    ...
    def set_use_curvature_redistribution(self, feature_size, mean_spacing, minimum_curvature, smooth):
        ...
        Args:
            ...
            minimum_curvature (float): The value of the curvature to be used instead of 0 in straight lines. It limits the maximum spacing between points. If not included, the default is 0.001.
            smooth (bool): Determines if the curvatures are to be averaged by a rolling 0.25-0.5-0.25 weighted rolling average.
        """
    ...
    def redistribute(self, polyline):
        """
        Redistributes points on closed loop polylines. The length of edges in the redistribution comes from a size
        function that is interpolated to the points that make up the polylines. By default this size function comes
