...
void MeMultiPolyTo2dmUnitTests::testCase4()
{
  ...
  std::string base =
    ...
    "ND    25            20.0            10.0             0.0\n"
    "ND    26            20.0            20.0             0.0\n"
    "ND    27 8.5108203108082   31.7579582765             0.0\n"
    "ND    28 19.918902028883 32.426918505776             0.0\n"
    "ND    29 14.906323151167 26.659242127202             0.0\n"
    "ND    30            40.0            20.0             0.0\n"
    "ND    31            40.0            30.0             0.0\n"
    "ND    32            40.0            40.0             0.0\n"
    "ND    33            40.0            50.0             0.0\n"
    ...
    "ND    54            60.0            10.0             0.0\n"
    "ND    55            60.0            20.0             0.0\n"
    "ND    56 48.371139982046 31.770815504174             0.0\n"
    "ND    57 59.828479471827 32.416248583564             0.0\n"
    "ND    58 54.803686244265 26.664267382002             0.0\n";
...
/// \brief Test providing seed points to the mesher for a polygon with a hole
//------------------------------------------------------------------------------
void MeMultiPolyTo2dmIntermediateTests::testbug11299()
{
  iTestFromPolyFile("bug11299", 10);
...
/// \brief Test for a bug where points are created with NAN coordinates
//------------------------------------------------------------------------------
void MeMultiPolyTo2dmIntermediateTests::testbug13701()
{
  iTestFromPolyFile("bug13701", 10);
} // MeMultiPolyTo2dmIntermediateTests::testbug13701
//------------------------------------------------------------------------------
/// \brief Test for a bug where points are created with NAN coordinates
//------------------------------------------------------------------------------
void MeMultiPolyTo2dmIntermediateTests::testbug13701_a()
{
  iTestFromPolyFile("bug13701_a", 10);
} // MeMultiPolyTo2dmIntermediateTests::testbug13701_a
//------------------------------------------------------------------------------
/// \brief Test for a bug where points are created with NAN coordinates
//------------------------------------------------------------------------------
void MeMultiPolyTo2dmIntermediateTests::test_srp_seed_pts()
{
...
{
  iTestFromPolyFile("bug14901", 10);
} // MeMultiPolyTo2dmIntermediateTests::testbug14901
//------------------------------------------------------------------------------
/// \brief Test for a bug where points are created with NAN coordinates
//------------------------------------------------------------------------------
void MeMultiPolyTo2dmIntermediateTests::testbug15183()
{
  iTestFromPolyFile("bug15183", 10);
} // MeMultiPolyTo2dmIntermediateTests::testbug15183
//------------------------------------------------------------------------------
/// \brief Test for a bug where points are created with NAN coordinates
//------------------------------------------------------------------------------
void MeMultiPolyTo2dmIntermediateTests::testbug15186()
{
