...
// 2. My own header
#include <xmsmesher/meshing/detail/MeRelaxer.h>
...
#include <xmsmesher/meshing/detail/MeRelaxer.t.h>
...
void MeRelaxerUnitTests::testRelaxWhileMeshing()
{
  ...
  VecInt outPoly = {0, 1, 2, 3, 4, 9, 14, 19, 24, 23, 22, 21, 20, 15, 10, 5};

  BSHP<MeRelaxer> relaxer = MeRelaxer::New();
  relaxer->Relax(outPoly, tin);
  VecPt3d& tinPts = tin->Points();
  VecPt3d expectedPts{
    {0.0, 0.0, 0},   {10.0, 0.0, 1},  {20.0, 0.0, 2},  {30.0, 0.0, 3},
    {40.0, 0.0, 4},  {0.0, 10.0, 0},  {11.3, 8.7, 1},  {20.9, 10.7, 2},
    {31.1, 9.2, 3},  {40.0, 10.0, 4}, {0.0, 20.0, 0},  {9.9, 18.2, 1},
    {20.1, 21.5, 2}, {30.1, 18.2, 3}, {40.0, 20.0, 4}, {0.0, 30.0, 0},
    {9.9, 28.6, 1},  {18.8, 31.3, 2}, {29.2, 29.1, 3}, {40.0, 30.0, 4},
    {0.0, 40.0, 0},  {10.0, 40.0, 1}, {20.0, 40.0, 2}, {30.0, 40.0, 3},
    {40.0, 40.0, 4},
  };

  TS_ASSERT_DELTA_VECPT3D(expectedPts, tinPts, 0.1);
