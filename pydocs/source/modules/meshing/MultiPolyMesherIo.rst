...
a collection of :class:`xms.mesher.meshing.PolyInput` objects, :class:`xms.mesher.meshing.RefinePoint` objects
...
functions from the :mod:`xms.mesher.meshing.mesh_utils` module.
...
The cell stream is organized as follows: [<CELL_TYPE>, <NUMBER_OF_POINTS> <POINT_ID_1>, ... <POINT_ID_N>,
<CELL_TYPE>, <NUMBER_OF_POINTS> <POINT_ID_1>, ... <POINT_ID_N>, ...]. So our example above could be read
as CELL_TYPE = 5 (TRIANGLE), there are 3 points, and the point ID's are 0, 40, and 1, and so on.
